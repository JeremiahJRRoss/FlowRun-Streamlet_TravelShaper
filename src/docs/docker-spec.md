...
for the Phoenix destination and generic OTLP HTTP transport in the configurable OTel
routing, which supports sending traces to Phoenix, Arize Cloud, any OTLP-compatible
backend, all three simultaneously, or none — controlled by the `OTEL_DESTINATION`
